            ...
            <div className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  We'll capture your face data to enable secure authentication
                  for voting. This data is encrypted and stored securely.
                </p>
              </div>

              <div className="bg-yellow-50 p-3 rounded-lg">
                <ul className="grid grid-cols-2 mt-1 space-y-1 text-xs text-yellow-800">
